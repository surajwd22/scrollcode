document.addEventListener("DOMContentLoaded", function () {
    const scrollableArea = document.getElementById("scrollable-area-1");
    const scrollLeftBtn = document.getElementById("scroll-left-btn-1");
    const scrollRightBtn = document.getElementById("scroll-right-btn-1");
